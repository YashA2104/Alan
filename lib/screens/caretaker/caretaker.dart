import 'package:alansdp/constants.dart';
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("Click to call Rajeev hands-free ")
                                    ],
                                  ),
                                ),
                                Padding(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                          "Type any message and send it to Rajeev ")
                                    ],
                                  ),
                                ),
                                Padding(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                        "Tap to see the current location of Rajeev")
                                  ],
                                ),
                              ),
                              Padding(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                        "Quick access to see what Rajeev is around")
                                  ],
                                ),
                              ),
                              Padding(
